...
rsecOptions<-function(id){
    ...
    tabPanel("Main Options",
             ...
             singleNumericInput(id, sidelabel="Set minimum size?", aboveLabel="e.g. 10", val="combineMinSize", help="minimum size required for a set of samples to be considered in a cluster because of 
